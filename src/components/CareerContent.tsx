...
export default function CareerContent() {
    ...
    const workTimeline = [
        { icon: "💻", title: "Audiens", place: "Alternance Chargé de Projet SI", date: "2025 - 2026", desc: ["► Maintenance et optimisation du site web avec Jahia", "► Développement d'outils internes en JavaScript et Java"], skills: ["Java", "Jahia", "Maven", "JavaScript", "MySQL", "Gestion de projet SI"] },
                        ...
                        <div className="relative border-l-2 border-primary">
                            {workTimeline.map((item, i) => (
                                ...
                                >
                                    ...
                                    <div className="flex flex-col">
                                        <p className="font-semibold">{item.title} — {item.place}</p>
                                    ...
                                    <div className="flex flex-wrap gap-2 mt-3">
                                        {item.skills.map((skill, idx) => (
                                            <span key={idx} className="px-2 py-1 text-xs font-medium bg-secondary rounded-full shadow-sm">
                                                {skill}
                                            </span>
                                        ))}
                                    </div>
